\chapter{习题7: 再讲点变量，加上点算术}

让我们通过声明更多的变量类型来熟悉变量的用法，这些类型包括 \ident{int}(整数型)、\ident{float}(单精度浮点型)、\ident{char}(字符型)、以及\ident{double}(双精度浮点型)。我们会在稍后的各种数学表达式中用到它们，同时你还会学到 C 语言的基础数学。
