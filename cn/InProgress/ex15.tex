...
在C语言中，指针闻名遐迩，又神秘莫测。我将教给你们一些词汇，籍以揭开指针的神秘面纱。事实上它们并不复杂，只是常常被人们胡乱操作，致使难以操作。如果你尽量避免愚蠢地操作指针，它们实际上相当容易。

为了便于讨论，我写了一个简单的小程序，能够用三种不同的方式打印一组人员年龄:\footnote{记住，学习本书时你要输入这些程序，也许当时不能理解，但请尝试在我解释以前自己弄明白。}
