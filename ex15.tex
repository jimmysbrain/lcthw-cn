...
They are not the same thing, even though C let's you work with them in many of the
...
at.  If you want the size of the full array, you have to use the array's name, \ident{age}
as I did on line 12.
