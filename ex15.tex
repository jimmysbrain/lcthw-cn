...
\item[ex15.c:35-39] This shows the "magic" of how the C compiler treats pointers and
    arrays as the same thing, even though they are not.  You just use the array syntax for
