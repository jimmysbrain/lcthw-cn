...
\begin{aside}{Ubuntu/Debian Valgrind Problems}
If you run valgrind and it says something like \verb|by 0x4052112: (below main) (libc-start.c:226)| instead of a line number in \file{main.c} then add run your valgrind command like this \verb|valgrind --track-origins=yes ./ex4| to make it work.  For some reason the Debian or Ubuntu version of \program{valgrind} does this but not
other versions.
\end{aside}
